  ...
  try {
    ...
    const svg = `
      <svg width="400" height="225" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="10" y="30" fill="white" font-size="24" font-family="Arial">${petName}</text>
        ...
        <text x="10" y="120" fill="white" font-size="16" font-family="Arial">Acq Date: ${petDate}</text>
        <text x="10" y="150" fill="white" font-size="16" font-family="Arial">${petGender}</text>
        <g transform="translate(10, 160) scale(0.25)">
          ${qrCodeSvg}
        </g>
      </svg>
    `;
